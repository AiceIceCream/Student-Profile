...
<section id="about">
  <div class="container">
    ...
    <div> 
      <h3>About Us</h3>
      <p>We are TechTok! A team of designers, developers, and digital marketers in majestic place of CDO. StudentInfoTrack is the first product released by TechTok. As Mark Victor Hansen said, "By recording your dreams and goals, you set in motion the process of becoming the person you most want to be..."</p>
      </div> 
  ...
  <div class="row about-cols">
    ...
    <div class="col-md-4 wow fadeInUp">
      <div class="about-col">
        ...
        <p class="text-center">
        Reaching more of your goals with Stundent Information Goal Tracker.
        </p>
      </div>
    </div>
  </div>
...
<section id="call-to-action" class="wow fadeIn">
  <div class="container text-center">
    <h3>Having Problems keeping track on your Student Information?</h3>
    <p class="text-center">
     With Student Information Goal Tracker you can set and track your student information, update, manage, and lots more.      </p>
    <a class="cta-btn" href="register.php">Get Started</a>
  </div>
</section>
